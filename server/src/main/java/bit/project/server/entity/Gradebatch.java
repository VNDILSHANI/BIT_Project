...
public class Gradebatch{
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "gradebatch")
    private List<Disposalgradebatch> disposalgradebatchList;


    public Gradebatch(Integer id){
        this.id = id;
    }

    public Gradebatch(Integer id, String code, Grade grade, String name){
        this.id = id;
        this.code = code;
        this.grade = grade;
        this.name = name;
