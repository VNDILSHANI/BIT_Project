...
public class EmployeeController{
    ...
    public Page<Employee> getAllBasic(PageQuery pageQuery, HttpServletRequest request){
        accessControlManager.authorize(request, "No privilege to get all employees' basic data", UsecaseList.SHOW_ALL_EMPLOYEES, UsecaseList.ADD_CATEGORIZATION, UsecaseList.UPDATE_CATEGORIZATION, UsecaseList.ADD_DISTRIBUTION, UsecaseList.UPDATE_DISTRIBUTION, UsecaseList.ADD_DRYERING, UsecaseList.UPDATE_DRYERING, UsecaseList.ADD_GRINDING, UsecaseList.UPDATE_GRINDING, UsecaseList.ADD_PACKING, UsecaseList.UPDATE_PACKING, UsecaseList.ADD_PERMENTING, UsecaseList.UPDATE_PERMENTING, UsecaseList.ADD_TASTING, UsecaseList.UPDATE_TASTING, UsecaseList.ADD_WITHERING, UsecaseList.UPDATE_WITHERING);
